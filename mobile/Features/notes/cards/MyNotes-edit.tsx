...
import { editNotes } from "@/database/notes/edit-myNotes";
...
type Props = {
  note: notes;
  onClose: () => void;
  onSave: (updateFeedItem: editMyNotes) => void;
};

export default function EditNotesMyNotes({ note, onClose, onSave }: Props) {
