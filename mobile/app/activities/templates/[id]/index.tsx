...
export default function TemplateScreen() {
    ...
    const [selectedActivity, setSelectedActivity] = useState<activities>(template?.activity as activities);
    ...
    const handleSave = async () => {
        ...
        try {
            setIsLoading(true);
            await editTemplate({ id: templateId, name, notes, activityId: selectedActivity!.id });

            queryClient.refetchQueries({ queryKey: ["get-activity-templates"], exact: true });
    ...
    if (!template) {
        return (
            <PageContainer>
                ...
                <AppText className="text-center text-red-500 mt-20">Template not found</AppText>
            </PageContainer>
        );
    }
                ...
                <View>
                    ...
                    <View className="mt-5">
                        ...
                        <AnimatedButton
                            ...
                            label={selectedActivity ? selectedActivity.name : "Select Activity"}
                    ...
                    >
                        <AppText className="text-2xl text-center my-10">Select Activity</AppText>
                        <ActivityDropdown onSelect={(activity) => {
