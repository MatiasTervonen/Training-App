...
export default function EmailVerified() {
  return (
    <View className="flex-1 justify-center items-center bg-gradient-to-tr from-slate-950 via-slate-950 to-blue-900 px-2">
      <View className="items-center justify-center gap-10 max-w-xl border-[1.5px] py-10 px-5 sm:px-10 rounded-xl bg-slate-900 shadow-lg">
        <AppText className="text-2xl mb-4">{APP_NAME}</AppText>
