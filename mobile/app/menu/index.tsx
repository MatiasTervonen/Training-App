...
import { ShieldUser, UserPen, Settings, LayoutGrid, MessageSquareMore, ContactRound, Share2 } from "lucide-react-native";
    ...
    <PageContainer>
      ...
      <View className="justify-between flex-1">
        <View className="gap-4">
          ...
          <LinkButton label={t("menu.sharing")} href="/menu/sharing-settings">
            <Share2 color="#f3f4f6" />
          </LinkButton>
