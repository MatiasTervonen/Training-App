  ...
  return (
    ...
    >
      <View className="flex-row justify-center">
        <View className="items-center justify-center bg-slate-700 p-5 rounded-md flex-1 border border-gray-400">
          <CalendarSync color="#f3f4f6" />
          <AppText className="mt-2 text-xl text-center">
            {reminder.type}
          </AppText>
        </View>
        <View className="items-center justify-center  bg-slate-700 p-5 rounded-md flex-1 ml-5 border border-gray-400">
          <Bell color="#f3f4f6" />
