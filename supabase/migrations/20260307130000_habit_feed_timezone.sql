-- Fix timezone issue: habit_toggle_log used CURRENT_DATE (UTC) for feed counts
-- but p_date is the user's local date. Replace CURRENT_DATE with p_date.
...
BEGIN
  ...
  -- 2. Count completed / total active habits for p_date (not CURRENT_DATE)
