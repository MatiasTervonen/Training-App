-- Fix: only show streak when today is all done.
-- Previously the loop ran even when today wasn't complete, accumulating
-- past days into a streak that shouldn't be displayed.
