-- Add is_gps_relevant, is_step_relevant, is_calories_relevant to the activity
-- object returned by activities_get_templates so the start-activity screen
-- can filter stats correctly when starting from a template.
