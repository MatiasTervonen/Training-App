-- Fix: get_friend_gym_session and get_friend_activity_session fail because
-- sessions table RLS blocks reading another user's session.
-- These functions already verify friendship + visibility before querying,
-- so SECURITY DEFINER is safe here.
