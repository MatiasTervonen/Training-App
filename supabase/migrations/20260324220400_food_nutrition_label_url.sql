-- Add nutrition label image URL to foods and custom_foods tables

ALTER TABLE foods ADD COLUMN nutrition_label_url TEXT;
ALTER TABLE custom_foods ADD COLUMN nutrition_label_url TEXT;

-- Update RPC to accept nutrition_label_url
