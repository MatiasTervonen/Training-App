-- Add image and explanation columns to food_reports
ALTER TABLE food_reports
  ADD COLUMN report_image_url TEXT,
  ADD COLUMN report_nutrition_label_url TEXT,
  ADD COLUMN explanation TEXT;

-- Update nutrition_report_food to accept new fields
...
-- Update admin_get_food_reports to return new fields
