...
import ChartTabSwitcher from "@/app/(app)/gym/components/analytics/AnalyticsChartTabSwitcher";
import AnalyticsHeatMap from "@/app/(app)/gym/components/analytics/AnalyticsHeatMap";
