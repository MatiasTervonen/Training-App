  ...
  return (
    <div className="h-full relative">
          ...
          >
            <div className="max-w-md mx-auto pt-12 px-5">
              ...
              <MoveToFolderDropdown
                ...
                currentFolderId={
                  (
                    moveToFolderItem.extra_fields as {
                      folder_id?: string;
                    } | null
                  )?.folder_id ?? null
                }
      ...
      <div className="absolute bottom-8 right-6 z-50 pointer-events-none">
        <Link
          href="/notes/quick-notes"
          className="pointer-events-auto w-14 h-14 rounded-full bg-slate-800 border-[1.5px] border-purple-400/60 shadow-lg shadow-purple-400/30 flex items-center justify-center hover:scale-110 transition-transform"
        >
