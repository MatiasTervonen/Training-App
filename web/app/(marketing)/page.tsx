  ...
  return (
    <div className="bg-slate-950 min-h-screen relative">
      <div className="max-w-7xl mx-auto">
        ...
        <main className="flex flex-col  justify-center items-center gap-10  text-gray-100 py-10 lg:py-20 bg-gradient-to-tr from-slate-950 via-slate-950 to-blue-900 rounded-t-xl px-5">
          <section>
            <AnimatedH1 />
