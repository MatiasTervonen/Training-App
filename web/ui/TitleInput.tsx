    ...
    <div className="flex flex-col w-full">
      ...
      <ModalSwipeBlocker>
        <input
          type="text"
          id={id}
          className={`w-full p-2 rounded-md border-[1.5px] border-gray-400 z-10 placeholder-gray-500 text-gray-100 bg-[linear-gradient(50deg,#0f172a,#1e293b,#333333)] hover:border-blue-500 focus:outline-none focus:border-green-300 ${className}`}
          value={value}
